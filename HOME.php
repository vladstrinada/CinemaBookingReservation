...
<link rel="shortcut icon" href="./img/img1.png" type="image/x-icon">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">New-Cinema</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="./event.php">Wydarzenia</a>
            </li>
            <li class="nav-item">
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Witamy w New-Cinema!</div>
          <div class="intro-heading text-uppercase">Zobacz nasz repertuar</div>
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="./UPDATE.PHP">Zobacz wiecej</a>
        </div>
      </div>
    </header>
