...
<p>Nazwa filmu:</p>
 ...
 <?php
include('conn.php');
$query=mysql_query("SELECT * FROM reservation.movies where No=1");
{
...
<p>Czas seansu:</p>
  ...
  <select name="Time">
    <option><?php
include('conn.php');
$query=mysql_query("SELECT * FROM reservation.time where id=1");
{
	$row=mysql_fetch_array($query);
	echo "".$row['time']."";
}
?></option>
    <option><?php
include('conn.php');
$query=mysql_query("SELECT * FROM reservation.time where id=2");
{
	$row=mysql_fetch_array($query);
	echo "".$row['time']."";
}
?></option>
    <option><?php
include('conn.php');
$query=mysql_query("SELECT * FROM reservation.time where id=3");
{
	$row=mysql_fetch_array($query);
	echo "".$row['time']."";
}
