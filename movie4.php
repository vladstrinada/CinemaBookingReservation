...
<form action="m4.php" method="post">
<p>Twoje imie:</p>
...
<p>Nazwa filmu:</p>
 ...
 <?php
include('conn.php');
$query=mysql_query("SELECT * FROM reservation.movies where No=4");
{
...
<p>Czas seansu:</p>
  <select name="Time">
    <option><?php
include('conn.php');
$query=mysql_query("SELECT * FROM reservation.time where id=7");
{
	$row=mysql_fetch_array($query);
	echo "".$row['time']."";
}
?></option>
    <option><?php
include('conn.php');
$query=mysql_query("SELECT * FROM reservation.time where id=8");
{
	$row=mysql_fetch_array($query);
	echo "".$row['time']."";
}
?></option>
    <option><?php
include('conn.php');
$query=mysql_query("SELECT * FROM reservation.time where id=9");
{
	$row=mysql_fetch_array($query);
	echo "".$row['time']."";
}
